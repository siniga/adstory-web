import { APPLY_SCOPE_VISUALS } from './environmentEditorVisuals'
import styles from './EnvironmentApplyScopePanel.module.css'

export default function EnvironmentApplyScopePanel({ value, onChange }) {
  return (
