import { APPLY_SCOPE_VISUALS } from './objectEditorVisuals'
import styles from './ObjectApplyScopePanel.module.css'

export default function ObjectApplyScopePanel({ value, onChange }) {
  return (
