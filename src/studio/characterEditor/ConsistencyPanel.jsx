import { CONSISTENCY_OPTIONS } from './characterEditorVisuals'
import styles from './ConsistencyPanel.module.css'

export default function ConsistencyPanel({ consistency, onChange }) {
  const toggle = (key) => {
  ...
  return (
    <section className={styles.panel}>
      <header className={styles.header}>
        ...
        <p className={styles.subtitle}>Lock attributes when regenerating across shots</p>
      </header>
